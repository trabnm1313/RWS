...
async function getData(){
  const db = SQLite.openDatabase("mytest.db");
...
async function openDatabase(){
  ...
  const databaseInfo = await FileSystem.getInfoAsync(FileSystem.documentDirectory+"SQLite/mytest.db")
  ...
  if ( !databaseInfo.exists ){
    ...
    await FileSystem.downloadAsync(uri, FileSystem.documentDirectory + "SQLite/mytest.db").then(() => {
